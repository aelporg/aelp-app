...
import { ClassroomMemberUncheckedUpdateManyWithoutUserInput } from '../classroom-member/classroom-member-unchecked-update-many-without-user.input';
...
@InputType()
export class UserUncheckedUpdateWithoutEnvirnmentPermissionsInput {
    ...
    @Field(() => ClassroomMemberUncheckedUpdateManyWithoutUserInput, {nullable:true})
    joinedClassrooms?: ClassroomMemberUncheckedUpdateManyWithoutUserInput;
