  ...
  return (
    <Popover className={'relative'}>
      ...
      >
        <Popover.Panel
          className={
            'p-1 absolute drop-shadow-lg bg-white right-3 rounded-lg border-2'
          }
        >
          {children}
        </Popover.Panel>
...
function PopoverMenuItem({
  ...
  return (
    <div className="px-2 py-2 items-center cursor-pointer  active:bg-gray-200 rounded-md flex hover:bg-gray-100">
