...
import { QuestionUncheckedUpdateManyWithoutAssessmentInput } from '../question/question-unchecked-update-many-without-assessment.input';
...
@InputType()
export class AssessmentUncheckedUpdateWithoutCompetitionInput {
    ...
    @Field(() => QuestionUncheckedUpdateManyWithoutAssessmentInput, {nullable:true})
    questions?: QuestionUncheckedUpdateManyWithoutAssessmentInput;
